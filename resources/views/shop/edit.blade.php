  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <div class="card p-3">
        ...
        <div class="card-body">
          <form action="{{route('shop.update',['id'=>$shop->id])}}" class="form-horizontal" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <select name="shop_keeper_id" class="form-control select2" oninput="setCustomValidity('');" required oninvalid="this.setCustomValidity('Please select ShopKeeper');">
                        ...
                        <option {{ $shop->user_id == $shop_keeper->id ? "selected" : "" }} value="{{ $shop_keeper->id }}">{{ $shop_keeper->username }} </option>
                        @endforeach
                      </select>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="shop_name" value="{{$shop->shop_name}}" name="shop_name">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="address" class="col-sm-12 col-form-label">Address<span class="text-danger">*</span></label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="address" value="{{$shop->address}}" name="address">
                    </div>
                  </div>
                  <div class="form-group row">
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <select name="category_id" class="form-control select2">
                        ...
                        <option {{ $shop->category_id == $category->id ? "selected" : "" }} value="{{ $category->id }}">{{ $category->name }} </option>
                        @endforeach
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <textarea class="form-control" id="notes" name="notes">{{$shop->notes}}</textarea>
                    </div>
                  </div>
                </div>
              </div>
