  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <div class="card p-3">
        ...
        <div class="card-body">
          <form action="{{route('discount.store')}}" class="form-horizontal" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
              <div class="row">
                <div class="col-md-6">
                <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="coupon_name" value="{{old('coupon_name')}}" name="coupon_name" oninput="setCustomValidity('');" required oninvalid="this.setCustomValidity('Please enter coupon name');">
                    </div>
                    @error('coupon_name')
                      <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="radio" value="0" name="is_price" checked> Yes
                      <input type="radio" value="1" name="is_price"> No
                    </div>
                  </div>
                  <div class="form-group row">
                        ...
                        <div class="col-sm-8" data-target-input="nearest">
                            <div class="input-group date" id="startdate" data-target-input="nearest">
                                <input name="startdate" oninput="setCustomValidity('');" required value="{{old('startdate')}}" oninvalid="this.setCustomValidity('Please choose start date');" id="startdate" type="text" class="form-control datetimepicker-input" data-target="#startdate" />
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="coupon_code" value="{{old('coupon_code')}}" name="coupon_code" oninput="setCustomValidity('');" required oninvalid="this.setCustomValidity('Please enter coupon code');">
                    </div>
                    @error('coupon_code')
                      <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                  ...
                  <div class="form-group row percentage" style="display:none">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="percentage" value="{{old('percentage')}}" name="percentage">
                    </div>
                    @error('percentage')
                      <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-sm-8" data-target-input="nearest">
                            <div class="input-group date" id="enddate" data-target-input="nearest">
                                <input name="enddate" oninput="setCustomValidity('');" required value="{{old('enddate')}}" oninvalid="this.setCustomValidity('Please choose end date');" id="enddate" type="text" class="form-control datetimepicker-input" data-target="#enddate" />
